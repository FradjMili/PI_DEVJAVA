...
public class Experiences implements Serializable {
    ...
    public Experiences(Integer id, String titre, Date dateDebut, Date dateFin, String description) {
        this.id = id;
        this.titre = titre;
   ...
   public Experiences( String titre, Date dateDebut, Date dateFin, String description,FosUser fosUser) {
    //    this.id = id;
        this.titre = titre;
        this.dateDebut = dateDebut;
        this.dateFin = dateFin;
    ...
    public String toString() {
        return "entities.Experiences[ id=" + id + " ]";
    }
