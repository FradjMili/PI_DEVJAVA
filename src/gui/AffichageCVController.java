...
ArrayList arraylist1 = (ArrayList)crud1.afficherExperiences();
...
ArrayList arraylist = (ArrayList)crud.afficherFormations();
...
Competences co = new Competences();
    ...
    @FXML
    private void supprimerEX(ActionEvent event) {
    }
    ...
    private void supprimerFO (ActionEvent event) throws SQLException {
        ...
        if(formationTable.getSelectionModel().getSelectedItem() != null){
            ...
            if(optionDeletePartnerAlert.get() == ButtonType.OK){
              //  FormationServices.supprimerFO(formationTable.getSelectionModel().getSelectedItem().getId());
        ...
        //formationTable.setItems(FormationServices.afficherFormations());
    }
