...
public class Ajout_experienceController implements Initializable {
   ...
   private int i=2;   
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     @FXML
    private void ajouter_experience(ActionEvent event) throws IOException {
...
String text =text1.getText();
 ...
 Experiences ex =new Experiences (titre,date1,date2,text,U2);
...
Experiences ex =new Experiences (titre,date1,date2,text,U2);
       ...
       FXMLLoader loader = new FXMLLoader(getClass().getResource("Ajout_competence.fxml"));
                        ...
                        Ajout_competenceController adm = loader.getController();
