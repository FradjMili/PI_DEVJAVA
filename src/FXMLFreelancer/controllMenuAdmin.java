...
//        Template.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/FXMLFreelancer/MenuClient.fxml"))));
    ...
    private void ButtonUserAction(MouseEvent event) throws IOException {
        Template.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/GUI/reclamation.fxml"))));
    }
    ...
    private void ButtonPubAction(MouseEvent event) throws IOException {
       Template.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/GUI/MyMenuFXML.fxml"))));
    }

    @FXML
    private void ToMenuDonation(MouseEvent event) throws IOException {
        //MyMenuDoFXML
                      Template.getInstance().changescene(new Scene(FXMLLoader.load(getClass().getResource("/GUI/MyMenuDoFXML.fxml"))));
